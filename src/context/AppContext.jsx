...
export function AppProvider({ children }) {
  ...
  const [company, setCompany] = useState({ name: 'Dar Is-Sajjied', address: 'Triq Ghar Dalam, Birżebbuġa, Malta', currency: 'EUR', vat_rate: 18, receipt_footer: 'Thank you — Grazzi — Grazie' })
  ...
  const [othRecords, setOthRecords] = useState([])
